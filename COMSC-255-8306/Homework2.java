...
public class Homework2
{
	public static void main (String[] args)
	{
		...
		if ("Mike".equals(firstName) || "Diane".equals(firstName)||"mike".equals(firstName) || "diane".equals(firstName))
		{
			discount=true;
		}
		...
		{
			System.out.println("You input is none of above, so default choice 12 inches.");
			inches=12;
			cost=12.99;
		}
		...
		{
			cost=cost-2;
			System.out.println("You can have $2.00 discount!");
		}
